                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end z-20 text-white">
                  ...
                  <div className="overflow-hidden">
                    <a 
                      ...
                      className="inline-flex items-center gap-2 bg-[#1dd1a1] hover:bg-[#15b085] text-white px-5 py-2.5 rounded text-sm font-bold transition-all duration-300 transform translate-y-0"
                    >
                      <span>{btnText}</span>
